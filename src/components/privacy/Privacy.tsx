    ...
    <div className="privacy-wrapper">
      <div className="container">
        <div className="header">
          ...
          <p>
            At Elie Badawi - PT, one of our main priorities is the privacy of
            our visitors. This Privacy Policy document contains types of
            information that is collected and recorded by Elie Badawi and how we
            use it.
          </p>
          ...
          <p>
            ...
            that they shared and/or collect in Elie Badawi. This policy is not
        ...
        <div className="log">
          ...
          <p>
            Elie Badawi follows a standard procedure of using log files. These
        ...
        <div className="children-info">
          ...
          <p>
            Elie Badawi does not knowingly collect any Personal Identifiable
